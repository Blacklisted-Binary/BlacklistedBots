...
<p align="center">
  <img src="https://img.shields.io/badge/Persona-Blacklisted%20Binary%20Labs-0d1117?style=for-the-badge&logo=ghost&logoColor=ff2d75" alt="Persona" />
  <img src="https://img.shields.io/badge/Mood-Dark%20Satirical-111827?style=for-the-badge&logo=thealgorithms&logoColor=22d3ee" alt="Mood" />
  <img src="https://img.shields.io/badge/Runtime-Python%20%2B%20React%20Ink-1f2937?style=for-the-badge&logo=python&logoColor=facc15" alt="Runtime" />
  <img src="https://img.shields.io/badge/Tools-43%2B-052e16?style=for-the-badge&logo=vercel&logoColor=22c55e" alt="Tools" />
  <img src="https://img.shields.io/badge/Tested-114%20Passing-14532d?style=for-the-badge&logo=checkmarx&logoColor=86efac" alt="Tested" />
  <img src="https://img.shields.io/badge/License-MIT-3f1d2e?style=for-the-badge&logo=open-source-initiative&logoColor=f9a8d4" alt="MIT" />
</p>
...
```mermaid
pie showData
    title BLACKLISTEDBOTS Value Allocation
    "Tooling + Execution" : 36
    "Safety + Governance" : 22
    "Memory + Context" : 18
    "Multi-Agent Coordination" : 14
    "UI/UX + Operator Experience" : 10
```
...
```mermaid
flowchart LR
    U[Operator Prompt] --> UI[CLI / React Ink Interface]
    UI --> E[Agent Loop Engine]
    E --> M[Model API Layer]
    M -->|tool_use| T[Tool Registry]
    T --> G[Permission + Hook Gate]
    G --> X[File • Shell • Search • Web • MCP • Tasks]
    X --> E
    E --> O[Structured Output: text/json/stream-json]
```
...
```mermaid
graph TD
    A[Lead Agent] --> B[Code Agent]
    A --> C[Research Agent]
    A --> D[Validation Agent]
    B --> E[Patch + Refactor]
    C --> F[Context + Evidence]
    D --> G[Test + Safety Checks]
    E --> H[Mergeable Outcome]
    F --> H
    G --> H
```
